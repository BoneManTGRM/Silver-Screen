...
SCIENCE: dict[str, Any] = {
    ...
    "tagline": (
        "A durable film-production system that detects fractures, applies "
        "bounded corrections, verifies improvement, and records successful "
        "repair patterns across story, video, and authorized voice layers."
    ),
