...
def minimal_correction(state: Dict[str, Any], fracture: Fracture) -> tuple[Dict[str, Any], str]:
    ...
    next_state["script"] = state.get("script", "") or ""
